...
serve(async (req: Request): Promise<Response> => {
  ...
  try {
    ...
    try {
      res = await fetch("https://api.openai.com/v1/chat/completions", {
        ...
        body: JSON.stringify({
          model: "gpt-4o-mini",
          messages: [
            { role: "system", content: "You analyze shipment delay risks." },
    ...
    return jsonResponse({ error: "Delay risk analysis failed" }, 500);
  }
});
